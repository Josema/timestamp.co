            ...
            if (!plugin.settings.always_visible) {
                ...
                if (!update) {
                    ...
                    if (plugin.settings.show_icon) {
                        ...
                        icon = (plugin.settings.custom_icon == null) ?
                              jQuery('<button type="button" class="otherclass Zebra_DatePicker_Icon' + ($element.attr('disabled') == 'disabled' ? ' Zebra_DatePicker_Icon_Disabled' : '') + '">Pick a date</button>')
                        :
                              plugin.settings.custom_icon;
